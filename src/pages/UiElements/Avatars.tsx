...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | JustBook - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for JustBook - React.js Tailwind CSS Admin Dashboard Template"
      />
